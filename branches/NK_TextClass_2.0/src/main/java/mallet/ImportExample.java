...
public class ImportExample {
	...
	public static void main(String[] args) throws IOException {
		...
		InstanceList instances = importer.readDirectory(new File("C:/D/mallet/test"));
		for (int i = 0; i < instances.size(); i++) {
			System.out.println("Target:"+instances.get(i).getTarget() + " Data:" +instances.get(i).getData() + " Name:" + instances.get(i).getName() + " Label:" + instances.get(i).getLabeling() + " Source:" +instances.get(i).getSource());
		}
		instances.save(new File("C:/D/mallet/test/test.mallet"));
